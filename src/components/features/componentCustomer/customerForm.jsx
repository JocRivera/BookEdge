...
const FormCustomer = ({ isOpen, onClose, onSave, customerData, rolID }) => {
  ...
  if (rolID == 0) return window.alert("No hay un rol con el nombre (Cliente)");
    ...
    <div className="modal-overlay-customer">
      <div className="modal-container-customer">
        <div className="modal-header-customer">
          ...
          <button onClick={cerrarDefinitivo} className="close-button-customer">
            ×
          </button>
        </div>
            ...
            >
              <div className="customer-form-grid">
                ...
                <div className="form-group-customer">
                  ...
                  />
                  {errors.eps && (
                    <span className="error-message-customer">{errors.eps}</span>
                  )}
                </div>
              </div>
            </div>
